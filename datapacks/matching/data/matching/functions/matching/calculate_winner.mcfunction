...
execute if score global number_of_winners matches 1 run function matching:matching/nested_functions/nested_function14
execute if score global number_of_winners matches 2.. run function matching:matching/nested_functions/nested_function15
execute if score global number_of_winners matches 1.. run schedule function matching:matching/delayed_code/delayed_code_id18 40 append
